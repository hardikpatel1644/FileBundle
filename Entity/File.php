...
namespace Oxind\FileBundle\Entity;
...
/**
 * @ORM\Entity(repositoryClass="Oxind\FileBundle\Entity\Repository\FileRepository")
...
class File
{
    ...
    public function preUpload()
    {
        ...
        {
            $this->path = $this->randomNo . "." . $this->getFile()->guessExtension();
        }
    }
